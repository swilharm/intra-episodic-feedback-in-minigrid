...
def eval_follower(model_path: Path, model_type: str, frame_stacking: bool, speaker: Type[Speaker],
...
models = [
    ...
    ('20240429_213324_ppo_fs_follower_9x9_4d_heuristic', 'ppo', True, HeuristicSpeaker)
]
